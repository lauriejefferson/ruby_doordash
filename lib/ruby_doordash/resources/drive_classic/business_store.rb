  ...
  module DriveClassic
    class BusinessStoreResource < Resource
      ...
      def update_business(external_business_id: , **business)
        Business.new patch_request("developer/v1/businesses/#{external_business_id}", body: business).body
      end
      ...
      def list_businesses()
        Businesses.new get_request("developer/v1/businesses").body
      end
      ...
      def update_store(external_business_id:, external_store_id:, **store )
        Store.new patch_request("developer/v1/businesses/#{external_business_id}/stores/#{external_store_id}", body: store).body
      end
